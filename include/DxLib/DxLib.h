...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x3210
#define DXLIB_VERSION_STR_T _T( "3.21 " )
#define DXLIB_VERSION_STR_W    L"3.21 "
...
#define MAX_LIVE2D_CUBISM3_MODEL_NUM				(32768)				// 同時に持てる Live2D Cubism 3 Model ハンドルの最大数
...
// DxLive2DCubism3.cpp 関数 プロトタイプ宣言

#ifndef DX_NON_LIVE2D_CUBISM3
